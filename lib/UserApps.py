from config import LOG, FAKER, APP_URL
from lib.posts import Posts, generate_fake_post
from lib.users import Users, generate_fake_user
from lib.comments import generate_comment
import random


def create_user_post_comment(login_access_token):
    '''Create a post for every user, and N comments'''
    user = {}
    ...
    for i in range(random.randint(1, 4)):
        new_comment = generate_comment(post_id)
